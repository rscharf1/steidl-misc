#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/gs/gsfs0/hpc01/rhel8/apps/conda3/envs/manta/bin/configManta.py --bam bams/HL60_ctrl.fixedRG.dedup.bam --bam bams/PY_low_1_CKDN260000486-1A_23KL3LLT4_L4.dedup.bam --bam bams/PY_high_1_CKDN260000485-1A_23KL3LLT4_L4.dedup.bam --reference GRCh38.primary_assembly.genome.fa --runDir manta_joint'
#
...
sys.path.append(r'/gs/gsfs0/hpc01/rhel8/apps/conda3/envs/mamba/envs/manta/share/manta-1.6.0-2/lib/python')
...
main(r"/gs/gsfs0/home/rscharf/steidl_lab/misc/goichi/WES/08_SV/manta_joint/runWorkflow.py.config.pickle","manta",MantaWorkflow)
